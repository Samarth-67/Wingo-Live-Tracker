...
def create_state(name, interval):
    return {
        ...
        # Strategy 1 (2-Round Continuous Pattern)
        "s1_base_pred": None,  # सुरवातीचा बेस प्रेडिक्शन सेव्ह करण्यासाठी (नवीन लॉजिक)
        "s1_pred_bs": "WAIT",
        "s1_pred_color": "WAIT",
        "s1_pred_nums": [],
        "s1_level": 1,
    ...
    if not state["s1_active"]:
        if len(state["full_history"]) >= 2:
            ...
            if pred_bs != "WAIT":
                ...
                state["s1_base_pred"] = pred_bs  # बेस व्हॅल्यू सेव्ह केली
                ...
                # Number Prediction mapping (तुमचे मूळ लॉजिक)
    ...
    if state["last_processed_issue"] != latest_issue:
        ...
        if state["s1_active"] and state["s1_pred_bs"] != "WAIT":
            ...
            if state["s1_pred_bs"] == latest_bs:
                ...
                # कलर आणि नंबरचे लॉजिक आधीसारखेच (नवीन निकालाच्या आधारावर)
